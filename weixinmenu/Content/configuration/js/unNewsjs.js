...
function DisplayUnNews()
{
    ...
    if (TopLineArray.length>0)
    {
        ...
        PicInfo="字体<select name=\"FontFamily\" id=\"FontFamily\" class=\"form\"></select>\
            ...
            <img src=\"/images/webimages/sysImages/blue/admin/Rect.gif\" alt=\"-\" width=\"18\" height=\"17\" border=\"0\" id=\"Img1\" style=\"cursor:pointer;\" title=\"选取字体颜色\" onclick=\"GetColor(this,'FontColor',event);\"/>&nbsp;\
            图片背景色:<input type=\"hidden\" name=\"FontBgColor\" id=\"FontBgColor\" />\
            <img src=\"/images/webimages/sysImages/blue/admin/Rect.gif\" alt=\"-\" width=\"18\" height=\"17\" border=\"0\" id=\"Img2\" style=\"cursor:pointer;\" title=\"选取图片前景色\" onclick=\"GetColor(this,'Imagesbgcolor',event);\"/>";
